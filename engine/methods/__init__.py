...
from engine.methods.custom import us_ca as custom_us_ca
...
from engine.methods import futa
from engine.methods import rate_schedule_percentage
from engine.methods import sui
...
REGISTRY = {
    ...
    "rate_schedule_percentage": rate_schedule_percentage.compute,
